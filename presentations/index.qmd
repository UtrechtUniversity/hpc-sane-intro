...
- Data Provider (usually a third party) vs Researcher
...
You can use the example input files from:

https://github.com/UtrechtUniversity/src-python-example.git

Try uploading the file `data/input_data/osm_roads.shp` from that repo.
...
input_folder = "/This PC/sane-data/source"

# Join folder path and filename
fp = os.path.join(input_folder, "osm_roads.shp")

data = open(fp)
result = len(data) # get the length of the data

print(result)

# Write the result
output_folder = "/This PC/sane-data/results"
# Change `myname` below
output = os.path.join(output_folder, "result_myname.txt")
